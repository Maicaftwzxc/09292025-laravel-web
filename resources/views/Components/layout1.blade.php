...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="min-h-full">
            <nav class="bg-orange-900/50">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            <div class="shrink-0">
                                <img src="https://cdn-icons-png.flaticon.com/128/3669/3669986.png" alt="Your Company" class="size-8" />
                            </div>
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    <x-nav-link href="/" :active="request()->is('/')">Home</a></x-nav-link>
                                    <x-nav-link href="/genre" :active="request()->is('genre')">Genre</a></x-nav-link>
                        ...
                        <div class="hidden md:block">
                            <div class="ml-4 flex items-center md:ml-6">
                                <button type="button" class="relative rounded-full p-1 text-gray-400 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
                                    ...
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" class="stroke-white size-6" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
                                ...
                                <el-dropdown class="relative ml-3">
                                    <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                        ...
                                        <img src="https://tse2.mm.bing.net/th/id/OIP.aw4R-ez09VC167zrnjdwogHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                                    </button>
                ...
                <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                    ...
                    <div class="border-t border-white/10 pt-4 pb-3">
                        <div class="flex items-center px-5">
                            <div class="shrink-0">
                                <img src="https://tse3.mm.bing.net/th/id/OIP.TCINwJT-chHbs_Xx8Xd-PAHaNL?rs=1&pid=ImgDetMain&o=7&rm=3" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                            </div>
                            <div class="ml-3">
            ...
            <main class="bg-[url('https://wallpaper-house.com/data/out/7/wallpaper2you_171699.jpg')] h-screen w-full bg-cover bg-center flex justify-center items-center ">
                {{ $mainpage ?? '' }}
            </main>
        </div>
    </body>
